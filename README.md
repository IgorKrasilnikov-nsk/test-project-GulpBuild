...
[gulp-less](https://www.npmjs.com/package/gulp-less) Компилятор Less файлов
[gulp-babel](https://www.npmjs.com/package/gulp-babel) Транспилер, @babel/core + @babel/preset-env + gulp-babel — три обязательных компонента
